    ...
    <footer>
        <div class="container">
            ...
            <div class="footer-support">
                <h3>Support Street & Ink</h3>
                <p>Help us continue documenting and celebrating street art around the world. Your support keeps our community thriving.</p>
                <div class="footer-support-buttons">
                    <a href="#" class="btn btn-primary">Support</a>
                    <a href="#" class="btn btn-secondary footer-support-btn-secondary">Become a Member</a>
                </div>
            </div>

            <div class="footer-bottom">
                <p>© 2023 Street & Ink. All rights reserved. | <a href="#">Privacy Policy</a> | <a href="#">Terms of Service</a></p>
            </div>
        </div>
    </footer>
